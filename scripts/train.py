"""Single configuration-driven training entry point."""
...
if __name__ == "__main__":
    ...
    assert_test_access_allowed({"execution_scale": "smoke", "test_seal_status": "sealed"}, "train")
    result = execute(runtime_config=args.runtime_config, experiment_config=args.experiment_config,
                     initialization_config=args.initialization_config, run_id=args.run_id, mode="train",
